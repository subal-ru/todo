  ...
  $('.changePass .submit').click(function () {
    ...
    $.ajax({
      ...
      if (!error['password'] && !error['newpassword'] && !error['newpassword_confirmation']) {
        ...
        (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_1__.showError)(error, 'changePass', 'password');
        (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_1__.showError)(error, 'changePass', 'newpassword');
        (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_1__.showError)(error, 'changePass', 'newpassword_confirmation'); // 入力パラメーターの削除
      ...
      (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_1__.showError)(error, 'changePass', 'password', '2');
      (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_1__.showError)(error, 'changePass', 'newpassword', '2');
      (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_1__.showError)(error, 'changePass', 'newpassword_confirmation', '2');
      return true;
    }).fail(function (error) {
      console.log(error);
    });
