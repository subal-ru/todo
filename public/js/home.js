...
function setAddBottonEvent() {
  var $addElement = $doc.getElementsByClassName('add')[0];
  $addElement.addEventListener('click', function () {
    return (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_0__.showModal)('modal add');
  });
...
function setItemBottonEvent() {
  ...
  for (var $i = 0; $i < $items.length; $i++) {
    $items[$i].addEventListener('click', function ($clickElement) {
      (0,_parts_common_js__WEBPACK_IMPORTED_MODULE_0__.showModal)('item-detail modal');
      setStatusData($clickElement, 'item-detail modal');
    });
  }
} // group追加ボタン
...
function setStatusData($ele, $classNames) {
  ...
  $modal.getElementsByTagName('input')['id'].value = $itemElement.dataset.id; // 自分以外のアイテムなら送信ボタンを非表示にする
...
function setModalCloseEvent() {
  var $modals = $doc.getElementsByClassName('modal');

  for (var $i = 0; $i < $modals.length; $i++) {
    $modals[$i].addEventListener('click', function ($clickElement) {
...
var $doc = document;
function headerSettingFunc() {
  setLoginBottonEvent();
  setRegisterBottonEvent();
  setLoginUserBottonEvent(); // ajax
...
function setLoginBottonEvent() {
  var $login = $doc.getElementsByClassName('login')[0];

  if ($login) {
    $login.addEventListener('click', function () {
      return (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.showModal)('modal login');
    });
    return true;
  }
...
function setRegisterBottonEvent() {
  var $register = $doc.getElementsByClassName('register')[0];

  if ($register) {
    $register.addEventListener('click', function () {
      return (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.showModal)('modal register');
    });
    return true;
  }
...
function setLoginUserBottonEvent() {
  var $loginUser = $doc.getElementsByClassName('header-loginUser')[0];

  if ($loginUser) {
    $loginUser.addEventListener('click', function (ele) {
      showLoginUserMenu(ele);
    });
    return true;
  }
...
function setRegisterSendBottonEvent() {
  $('.send-btn.register').click(function () {
    ...
    $.ajax({
      type: 'post',
      url: 'registerCheck',
      //laravelではパスの末尾に/をつけてはいけない405エラーになる（routeエラー？）
      dataType: 'json',
      data: {
...
/******/ 	__webpack_require__.O(undefined, ["css/mypage","css/root","css/home"], () => (__webpack_require__("./resources/js/home.js")))
/******/ 	__webpack_require__.O(undefined, ["css/mypage","css/root","css/home"], () => (__webpack_require__("./resources/sass/home.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/mypage","css/root","css/home"], () => (__webpack_require__("./resources/sass/root.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/mypage","css/root","css/home"], () => (__webpack_require__("./resources/sass/mypage.scss")))
