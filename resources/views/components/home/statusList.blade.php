...
<div class={{$statusName}}>
    ...
    <div class="list">
        ...
        <div class="item-wrapper">
            <div class="item" data-status="{{$item->status}}" data-id="{{$item->id}}" data-groupid="{{$item->group_id}}" data-groupname="{{$item->group_name}}" data-userid="{{$item->userid}}" data-myid={{session('userid')}} draggable="true" style="background-color:{{$item->color}};">
